...
namespace Rebound {
    ...
    void ImGuiLayer::OnAttach() {
        ...
        colors[ImGuiCol_MenuBarBg]              = ImVec4(0.31f, 0.31f, 0.31f, 1.00f);
        ...
        colors[ImGuiCol_Button]                 = ImVec4(0.30f, 0.30f, 0.31f, 1.00f);
        colors[ImGuiCol_ButtonHovered]          = ImVec4(0.44f, 0.45f, 0.46f, 1.00f);
        colors[ImGuiCol_ButtonActive]           = ImVec4(0.13f, 0.14f, 0.14f, 1.00f);
        ...
        colors[ImGuiCol_SeparatorHovered]       = ImVec4(0.18f, 0.33f, 0.49f, 1.00f);
